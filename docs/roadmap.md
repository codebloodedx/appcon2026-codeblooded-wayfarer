...
| 3. Integration | Route map and live camera together; one reviewed sign triggers brief Gemini speech | Required area PRs merged | Stationary end-to-end demo, route line/next turn/ETA if available, `unknown` case, source and simulation labels |

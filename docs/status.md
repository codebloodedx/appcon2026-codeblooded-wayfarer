...
Do not claim final submission readiness yet. Run one physical sign plus one unknown live-camera case, promote only the successful sign, verify alert speech and parked Q&A, then commit/push the integration branch through the repository's PR review rules.

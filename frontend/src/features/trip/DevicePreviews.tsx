    ...
    <section className="devices-view" aria-labelledby="devices-title">
      ...
      <div className="device-grid">
        <article className="device-card">
          ...
          <div className="phone-frame"><div className="phone-island" /><div className="device-top"><span>RoamRight</span><small>🇯🇵 Japan</small></div><PreviewContent /><div className="phone-action">Parked details</div></div>
        ...
        <article className="device-card">
          ...
          <div className="ev-frame"><div className="ev-side"><strong>R</strong><span>Trip</span><span>Signs</span></div><div className="ev-main"><div className="device-top"><span>{trip.destination}</span><small>Simulated location</small></div><PreviewContent compact /><div className="ev-footer"><span>Audio: off</span><span>ETA: —</span></div></div></div>
